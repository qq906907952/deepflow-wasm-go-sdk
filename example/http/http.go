...
func (p httpHook) OnCheckPayload(ctx *sdk.ParseCtx) (protoNum uint8, protoStr string) {
	//TODO implement me
	panic("implement me")
}

func (p httpHook) HookEnable() sdk.HookBitmap {
	//TODO implement me
	panic("implement me")
}
...
func (p httpHook) OnCheckPayload(baseCtx *sdk.ParseCtx) uint8 {
	return 0
}
